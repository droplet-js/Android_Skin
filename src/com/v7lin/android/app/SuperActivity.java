 ...
 * 
 * 其他： Progress Wheel PhotoView Nine Old Androids
 */
/**
 * 参考文献：
 * http://www.eoeandroid.com/forum.php?mod=viewthread&tid=272453&reltid=35453
 * &pre_thread_id=0&pre_pos=2&ext=CB
 * http://www.oschina.net/translate/40-developer
 * -tips-for-android-optimization?from=20130922
 * http://www.eoeandroid.com/thread-311194-1-1.html
 * https://github.com/Trinea/AndroidCommon http://www.23code.com/
 * https://github.com/yangfuhai/afinal https://github.com/wyouflf/xUtils
 * http://my.eoe.cn/1181897/archive/21230.html?f=nge
 * http://blog.csdn.net/cuiweijie3/article/details/9464925
 * https://github.com/davidleen/android-BaseAdapter-enhance 混淆文献：
 * http://blog.csdn.net/dianyueneo/article/details/7221323
 * 
...
public class SuperActivity extends Activity {
	 ...
	 * 设置屏幕全屏与否
	 */
	protected final void requestFullScreen(boolean fullScreen) {
		if (fullScreen) {// 全屏
	 ...
	 * 设置屏幕待机与否
	 */
	protected final void requestKeepScreenOn(boolean keepScreenOn) {
	 ...
	 */
	protected final void requestOrientation(int requestedOrientation) {
